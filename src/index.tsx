...
<nav class="navbar">
  <a href="/" class="brand">
    <img src="/static/devon.jpg" alt="Finding Peace" class="brand-logo" onerror="this.style.background='linear-gradient(135deg,#4a9b8e,#c8923a)';this.style.display='flex'">
      ...
      <div style="display:flex;flex-direction:column;align-items:center;gap:1.4rem">
        <div style="position:relative">
          <div style="width:270px;height:270px;border-radius:50%;background:linear-gradient(135deg,var(--teal),var(--teal-l));padding:5px;box-shadow:0 12px 40px rgba(74,155,142,.35)">
            <img src="/static/devon.jpg" alt="Devon - Finding Peace" style="width:100%;height:100%;object-fit:cover;object-position:center top;border-radius:50%;border:4px solid #fff" onerror="this.parentElement.innerHTML='<div style=\'width:100%;height:100%;border-radius:50%;background:linear-gradient(135deg,#4a9b8e,#c8923a);display:flex;align-items:center;justify-content:center;color:#fff;font-size:2.5rem;font-weight:800;font-family:Dancing Script,cursive\'>D</div>'">
          </div>
      ...
      <div class="reveal" style="text-align:center">
        <div style="position:relative;display:inline-block">
          <div style="width:280px;height:280px;border-radius:28px;background:linear-gradient(135deg,var(--teal),var(--teal-l));padding:5px;box-shadow:0 16px 50px rgba(74,155,142,.3);display:inline-block">
            <img src="/static/devon.jpg" alt="Devon - Finding Peace" style="width:100%;height:100%;object-fit:cover;object-position:center top;border-radius:24px;border:4px solid #fff" onerror="this.parentElement.innerHTML='<div style=\'width:100%;height:100%;border-radius:24px;background:linear-gradient(135deg,#4a9b8e,#c8923a);display:flex;align-items:center;justify-content:center;color:#fff;font-size:3rem;font-weight:800;font-family:Dancing Script,cursive\'>Devon</div>'">
          </div>
    ...
    <div style="display:grid;grid-template-columns:320px 1fr;gap:4rem;align-items:start">
      ...
      <div class="reveal" style="position:sticky;top:90px" id="about-sidebar">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:.7rem;margin-top:1rem">
          <img src="/static/devon.jpg" alt="Devon" style="border-radius:14px;width:100%;object-fit:cover;border:1px solid var(--border)" onerror="this.style.display='none'">
        </div>
      </div>
...
<section style="background:linear-gradient(160deg,#1a2e28,#0d2318,#1a2438);padding:4.5rem 1.5rem 3rem;position:relative;overflow:hidden;text-align:center">
  ...
  <div class="container" style="position:relative;z-index:1">
    <div style="width:100px;height:100px;border-radius:50%;background:linear-gradient(135deg,var(--teal),var(--teal-l));margin:0 auto 1.2rem;padding:4px;box-shadow:0 8px 30px rgba(74,155,142,.4)">
      <img src="/static/devon.jpg" alt="Devon" style="width:100%;height:100%;object-fit:cover;object-position:center top;border-radius:50%;border:3px solid #fff" onerror="this.parentElement.innerHTML='<div style=\'width:100%;height:100%;border-radius:50%;background:linear-gradient(135deg,#4a9b8e,#c8923a);display:flex;align-items:center;justify-content:center;color:#fff;font-size:2.2rem;font-weight:800;font-family:Dancing Script,cursive\'>D</div>'">
    </div>
