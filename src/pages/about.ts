...
<section class="py-16 px-4 bg-white">
  <div class="max-w-3xl mx-auto">
    ...
    <div class="space-y-8 text-gray-700 leading-relaxed text-lg">
      ...
      <blockquote class="border-l-4 pl-6 py-2 font-display italic text-xl text-gray-600" style="border-color:#d4713f;">"I used to think asking for help was admitting defeat. Now I know it is the bravest thing a person can do."</blockquote>
      <p>Recovery did not happen overnight. It was thousands of small decisions. Some days choosing to call a friend instead of picking up. Some days choosing to stay. Some days choosing to laugh instead of cry, or cry AND laugh, because honestly, that is allowed too.</p>
      ...
      <blockquote class="border-l-4 pl-6 py-2 font-display italic text-xl text-gray-600" style="border-color:#8ab88e;">"I did not know I was building a community. I thought I was just talking to myself at 2am."</blockquote>
      <p>Mental health and addiction are not topics people talked about openly when I was growing up. There was shame. Whispers. Closed doors. I am here to open those doors wide open and make sure no one has to suffer in silence.</p>
...
<section class="py-20 px-4 band-sage">
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="peace-card p-7"><div class="text-4xl mb-4">&#127897;&#128172;</div><h3 class="font-bold text-gray-800 text-xl mb-3">Amplify Your Voice</h3><p class="text-gray-600 leading-relaxed">Your story matters. Sharing it might be the thing that saves someone else's life.</p></div>
    </div>
  </div>
</section>
